    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1.5 rounded-full appearance-none cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-logo-primary/40 ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
            background: `linear-gradient(to right, var(--color-logo-primary) 0%, var(--color-logo-primary) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 25%, transparent) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 25%, transparent) 100%)`,
          }}
        />
