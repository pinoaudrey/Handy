...
const ModelCard: React.FC<ModelCardProps> = ({
  ...
  const getInteractiveClasses = () => {
    ...
    return "cursor-pointer hover:border-logo-primary/50 hover:shadow-md hover:-translate-y-px active:translate-y-0 group";
  };
  ...
  return (
    ...
    >
      ...
      <hr className="w-full border-mid-gray/15" />
      ...
      <div className="flex items-center gap-3 w-full -mb-0.5 mt-0.5 h-5">
        ...
        {onDelete && (status === "available" || status === "active") && (
          <Button
            ...
            className="flex items-center gap-1.5 text-error/80 hover:text-error hover:bg-error/10"
          >
